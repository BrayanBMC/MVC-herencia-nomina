...
import java.text.DecimalFormat;
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==objetoVista.getBotonnomina()){
            ...
            objetoVista.getTxtnomina().append("Salario Básico:"+ formato.format(objetoModelo.getSalariobasico())+"\n");
            objetoVista.getTxtnomina().append("Dias Trabajados:"+ objetoModelo.getDias()+"\n");
            objetoVista.getTxtnomina().append("+ Auxilio de transporte:"+ formato.format(objetoModelo.getAuxilioTransporte())+"\n");

            objetoVista.getTxtnomina().append("- Salud:"+ formato.format(objetoModelo.getSalud())+"\n");
